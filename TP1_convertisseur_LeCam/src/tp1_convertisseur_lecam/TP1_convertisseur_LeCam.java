 ...
 */
package tp1_convertisseur_lecam;
 ...
 */
public class TP1_convertisseur_LeCam {
    ...
    public static void main(String[] args) {
        ...
        switch (saisie){
            ...
            case 2 : valeur1 = CelciusVersFarenheit(valeur1);
            System.out.println(sauvegarde+"degré Celcius est égal à " +valeur1+" degré Farenheit"); break;
            case 3 : valeur1 = KelvinVersCelcius(valeur1);
            System.out.println(sauvegarde+"degré Kelvin est égal à " +valeur1+" degré Celcius"); break;
            case 4 : valeur1 = FarenheitVersCelcius(valeur1);
            System.out.println(sauvegarde+"degré Farenheit est égal à " +valeur1+" degré Celcius"); break;
